...
export default function Page(){
    return(<div className="max-w-7xl mx-auto my-10">
        ...
        <div className="flex flex-col lg:flex-row gap-5 ">
            <div className="w-full lg:w-3/5 grid grid-cols-10 lg:grid-cols-12  gap-1 lg:gap-3 ">
                <div className="col-span-2 lg:col-span-2 flex flex-col gap-3">
                    <img src="https://images.unsplash.com/photo-1505740420928-5e560c06d30e?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" className="w-full" />
                ...
                <div className="col-span-8 h-full lg:col-span-10">
                    <img src="https://images.unsplash.com/photo-1505740420928-5e560c06d30e?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" className="h-full" />
                </div>
            </div>

            <div className="lg:w-1/3 mx-3 lg:mx-0 flex flex-col gap-3">
                {/* PRODUCT NAME */}
                <div>
                    <p className="font-bold text-xl">Havic HV G-92 Gamepad</p>
                </div>
                ...
                <div className="flex border-b border-gray-400 pb-5">
                    <p className="text-wrap">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Pariatur voluptate quos quam, cumque, commodi corrupti cupiditate aliquid facere ducimus dignissimos repudiandae reiciendis eos repellat consequatur earum doloremque </p>
                </div>
                ...
                <div className="flex items-center gap-3 ">
                    ...
                    <div className="flex gap-3">
                        ...
                        <Button variant={"outline"} className="bg-secondary text-white">M</Button>
                ...
                <div className="flex gap-3">
                    ...
                    {/* BUY BUTTON */}
                    <div className="w-1/3">
                        <Button variant={"secondary"} className="text-white w-full">Buy Now</Button>
                    </div>
